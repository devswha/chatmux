<p align="center">
  <img src="../assets/readme-hero.svg" alt="ChatMux — 所有编码代理，一个指挥台：Codex、Claude、Gajae Code、Cursor 和 OpenCode 会话多路复用到一个自托管界面" width="900">
</p>
...
你照常在 tmux 中运行编码代理 — Gajae Code、Claude Code、Codex、Cursor CLI、OpenCode、Oh My Pi。ChatMux 会自动发现它们，并把所有会话显示在一个浏览器页面中，无论你使用桌面还是手机。
